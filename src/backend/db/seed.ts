import { GRID_COLS, GRID_ROWS, GRID_TOTAL, PrizeConsolation, PrizeGrand, cellId, makeEtag, type Cell, type CellId, type GridMeta, type GridState, type Prize } from './schema';
